...
assign #`RegDel notReset = (Count > 10);

//-------------------------------------------------------------
// Hacks specific to  the Verilator simulator
//-------------------------------------------------------------
...
//-------------------------------------------------------------
// For normal simulators, pass through Link signals
//-------------------------------------------------------------
...
// verilog code via the `fatal definition in test_defs.v.
// Any data logging, error message displays etc., on a fatal,
